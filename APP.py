...
#jika root sudah ada, tampilkan menu utama menggunakan tabs
    ...
    with tab2:
        ...
        induk_nama = st.text_input("nama kategori induk tampat cabang ditambahkan:")
    ...
    #TAB3: CARI JALUR
    with tab3:
        st.subheader("Pencarian Breadcrump")
        target_cari = st.text_input("Nama kategori yang ingin dicari")
